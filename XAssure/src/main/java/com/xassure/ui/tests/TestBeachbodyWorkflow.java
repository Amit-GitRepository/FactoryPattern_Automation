...
public class TestBeachbodyWorkflow extends BaseTest{
	...
	public void openBeachbodyApplication() {
		...
		Reporting.getLogger().log(LogStatus.PASS, "User successfully added Double Profuct to Cart");
	}
	...
	public void enterCheckoutDetails() {
		...
		Reporting.getLogger().log(LogStatus.PASS, "User has successfully entered email and shipping details");
	}
